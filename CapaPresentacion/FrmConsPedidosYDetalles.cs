...
namespace CapaPresentacion
{
    public partial class FrmConsPedidosYDetalles : Form
    {
        ...
        public FrmConsPedidosYDetalles()
        {
            InitializeComponent();
        }
        ...
        private void CargarDatosDGVPedidos()
        {
            ...
            //Idea sacada de la tutoria de Johan Acosta:
            //https://www.youtube.com/watch?v=2IWiBqwDgKM
            Pedidos[] arregloPedidos = pedidos.ObtenerPedidos();
        ...
        private void BttMostrarDetalles_Click(object sender, EventArgs e)
        {
            ...
            DetallesPedido[] TodoslosPedidos;
            ...
            {
                TodoslosPedidos = new DetallesPedido[0];
            }
            ...
            for (int i=0;i<TodoslosPedidos.Length;i++)
            {
        ...
        private void MostrarDetalles(int numero)
        {
            ...
            DetallesPedido[] TodosLosDetalles= detallesPedidoN.ObtenerDetallesPedidos();//obtener todos los detalles de pedidos
            ...
            {
                for (int i=0;i<TodosLosDetalles.Length;i++)
                {
